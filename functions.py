...
class FunctionsOfSchedule(GeneralFunctions):
        ...
        match type_function:
            case 'add':
                if verification:
                    ...
                    # validating for scheduling ==================================================
                    if self.validation([informations[0][0], informations[0][2]], 5) and self.validation(informations[0][2], 3) and self.validation(informations[0][4], 3):
                        # insert ascheduling in treeview ======================================
                        match type_insert:
                            case 'button':
                                self.insert_treeview_informations(treeview, informations, 'scheduling')
    ...
    def register_with_barCode(self, treeview, informations, entrys):
        ...
        if service:
            ...
            if value:
                ...
                for index, information in enumerate([service[0][1], value[0][0], service[0][0]]):
                    if isinstance(entrys[index], CTkComboBox):
                        entrys[index].set('')
                        entrys[index].set(information)
                    else:
                ...
                cheatInformations = [[informations[0][0], service[0][1], informations[0][2], value[0][0], informations[0][4],  service[0][0], informations[0][6]]]
            ...
            self.message_window(2, 'Sem registro', 'Código inexistente')
    ...
    def send_message_schedule(self, treeview, type_message, message=''):
        ...
        if res:
            ...
            clients = self.pick_informations_treeview(treeview)
            if len(clients) > 0:
                self.bot.open_whatsapp()
                self.bot.pause('assets/image_pause.jpg')
                self.bot.whatsapp(clients, type_message=type_message, message=message)
        ...
        if self.message_window(4, 'Comfimação', f'Finalisar o cadastro de {informations[0].title()}?'):
            ...
            self.dataBases['informations'].crud(
                registerClient.format(
                    informations[0], informations[1], informations[2], informations[3], informations[4], informations[5],
                    informations[6], informations[7], informations[8], informations[9], informations[10], informations[11], informations[12]
                )
            )
            # deleting and inserting informations in treeview ===============================
    ...
    def update_client(self, treeview, informations, entrys):
        ...
        if treeview.selection():
            informationsDataBase = self.dataBases['informations'].crud(
                updateClient.format(
                    informations[0], informations[1], informations[2], informations[3], informations[4], informations[5], informations[6],
                    informations[7], informations[8], informations[9], informations[10], informations[11], informations[12], self.selection_treeview(treeview)[0][0]
                )
            )
            # delete informations of treeview ==============================
            self.delete_informations_treeview(treeview, 'client')
...
class FunctionsOfServiceInformations(GeneralFunctions):
    ...
    def register_service(self, informations, treeview):
        if self.validation(informations, 5) and self.validation(self.treating_numbers(informations[1], 1), 4, 1):
            if self.message_window(4, 'Comfimação', f'Finalisar o cadastro de serviço?'):
                # informations of treeview ====================
                self.dataBases['informations'].crud(registerServices.format(informations[0], self.treating_numbers(informations[1], 1)))
                # deleting and inserting informations in treeview ===============================
    ...
    def update_service(self, treeview, informations):
        if self.validation(informations, 5) and self.validation(self.treating_numbers(informations[1], 1), 4, 1):
            # update informations =========================================
            if treeview.selection():
                informationsDataBase = self.dataBases['informations'].crud(updateService.format(informations[0], self.treating_numbers(informations[1], 1), self.selection_treeview(treeview)[0][0]))
                # delete informations of treeview ==============================
                self.delete_informations_treeview(treeview, 'service')
...
class FunctionsOfBarCodeInformations(GeneralFunctions):
        ...
        if self.validation(informations[0:3], 5) and self.validation(informations[2], 6):
            if self.message_window(4, 'Comfimação', f'Finalisar o cadastro do código?'):
                ...
                if directoryBarCode[0] != '.png':
                    # registing ====================
                    self.dataBases['informations'].crud(
                        registerBarCode.format(informations[0], informations[1], directoryBarCode[1], directoryBarCode[0], informations[3])
                    )
                    # deleting and inserting informations in treeview ===============================
    ...
    def update_barCode(self, treeview, informations):
        if self.validation(informations[0:2], 5):
            if treeview.selection():
                # update informations =========================================
                informationsDataBase = self.dataBases['informations'].crud(
                    updateBarCode.format(informations[0], informations[1], informations[3], self.selection_treeview(treeview)[0][0])
                )
    ...
    def create_image_barCode(informations):
        ...
        if directory != '':
            ...
            code.save(file_path)
            cairosvg.svg2png(url=file_path + '.svg', write_to=file_path + '.png', output_width=523, output_height=280)
            os.remove(file_path + '.svg')

        return [file_path + '.png', code.get_fullcode()]
...
class FunctionsOfInformationsStock(GeneralFunctions):
    ...
    def register_InformationsStock(self, informations, treeview):
        if informations[1] != "":
            if self.message_window(4, 'Comfimação', f'Finalisar o cadastro da informação?'):
                # informations of treeview ====================
                self.dataBases['informations'].crud(registerInformationsOfStock.format(informations[0], informations[0].lower(), informations[1]))
                # deleting and inserting informations in treeview ===============================
    ...
    def update_InformationsStock(self, treeview, informations, **kwargs):
        if informations[1] != '':
            # update informations =========================================
            if treeview.selection():
                informationsDataBase = self.dataBases['informations'].crud(updateInformationsOfStock.format(informations[0], informations[0].lower(), informations[1], self.selection_treeview(treeview)[0][0]))
                # delete informations of treeview ==============================
                self.delete_informations_treeview(treeview, kwargs['typeInformations'])
                ...
                if self.message_window(4, 'Comfimação', f'Finalisar o cadastro do produto?'):
                    self.dataBases['stock'].crud(
                        kwargs['sqlRegister'].format(
                            informations[0], informations[1], informations[2], '0' if informations[3] == '' else informations[3],
                            informations[4], self.treating_numbers(informations[5], 1), informations[6], '0' if informations[7] == '' else informations[7],
                            informations[3] if informations[8] == '' else informations[8], datetime.today().strftime('%d/%m/%Y  %H:%M') if informations[9] == '' else informations[9],
                            datetime.today().strftime('%d/%m/%Y  %H:%M') if informations[10] == '' else informations[10], informations[11], informations[12]
                        ))
                    # deleting and inserting informations in treeview ===============================
            ...
            if self.validation(informations[0:8], 5) and self.validation(informations[3], 3) and self.validation(valuesPrice[0], 4) and self.validation(valuesPrice[1], 4):
                if self.message_window(4, 'Comfimação', f'Finalisar o cadastro do produto?'):
                    self.dataBases['stock'].crud(
                        kwargs['sqlRegister'].format(
                            informations[0], informations[1], informations[2], '0' if informations[3] == '' else informations[3],
                            informations[4], self.treating_numbers(informations[5], 1), self.treating_numbers(informations[6], 1), informations[7],
                            'NENHUM' if informations[8] == '' else informations[8], 'SEM PAGAMENTO' if informations[9] == '' else informations[9],
                            datetime.today().strftime('%d/%m/%Y  %H:%M') if informations[10] == '' else informations[10], informations[11], informations[12], datetime.today().strftime('%d/%m/%Y  %H:%M')
                        ))
                    # deleting and inserting informations in treeview ===============================
                ...
                if self.validation(informations[0:7], 5) and self.validation(informations[3], 3) and self.validation(self.treating_numbers(informations[5], 1), 4):
                    self.dataBases['stock'].crud(
                        kwargs['sqlUpdate'].format(
                            informations[0], informations[1], informations[2], '0' if informations[3] == '' else informations[3],
                            informations[4], self.treating_numbers(informations[5], 1), informations[6], '0' if informations[7] == '' else informations[7],
                            int(informations[8]) - int(informations[7]), datetime.today().strftime('%d/%m/%Y  %H:%M') if informations[9] == '' else informations[9],
                            datetime.today().strftime('%d/%m/%Y  %H:%M'), informations[11], informations[12], self.selection_treeview(treeview)[0][0]
                        )
                    )
                    # delete informations of treeview ==============================
                    self.delete_informations_treeview(treeview, kwargs['typeStock'])
                ...
                if self.validation(informations[0:8], 5) and self.validation(informations[3], 3) and self.validation(valuesPrice[0], 4) and self.validation(valuesPrice[1], 4):
                    self.dataBases['stock'].crud(
                        kwargs['sqlUpdate'].format(
                            ...
                            informations[4], self.treating_numbers(informations[5], 1), self.treating_numbers(informations[6], 1), informations[7],
                            'NENHUM' if informations[8] == '' else informations[8], 'SEM PAGAMENTO' if informations[9] == '' else informations[9],
                            informations[10], informations[11], informations[12], datetime.today().strftime('%d/%m/%Y  %H:%M'), self.selection_treeview(treeview)[0][0]
                        )
                    )
                    # delete informations of treeview ==============================
                    self.delete_informations_treeview(treeview, kwargs['typeStock'])
