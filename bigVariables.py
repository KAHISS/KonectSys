...
tableWithInformationsScheduleTreeview1 = [['', '', '', '', ''], ['    ID    ', '    Cliente    ', '    Serviço    ', '    Horário   ', '    Valor    ']]
tableWithInformationsScheduleTreeview2 = [['', '', '', '', ''], ['M/Pagamento', 'Data', 'Profissional', 'Agendamento', 'C/Serviço']]
...
registerClient = (
    'INSERT INTO Clientes (nome, nascimento, e_mail, filhos, telefone, cliente_desde, endereço, CEP, bairro, cidade, estado, foto, observação)'
    'VALUES ("{}", "{}", "{}", "{}", "{}", "{}", "{}", "{}", "{}", "{}", "{}", "{}", "{}")'
)
searchClient = '''SELECT * 
                  FROM Clientes
...
tableWithInformationsClientTreeview1 = [['', '', '', '', ''], ['    ID    ', '    Nome    ', '    Nascimento    ', '    E-mail    ', ' Filhos ', 'Telefone']]
...
registerProfessional = (
    'INSERT INTO Profissionais (nome, nascimento, admissão, e_mail, telefone, emergência, endereço, CEP, bairro, cidade, estado, foto, observação)'
    'VALUES ("{}", "{}", "{}", "{}", "{}", "{}", "{}", "{}", "{}", "{}", "{}", "{}", "{}")'
)
...
# tables for client informations =================================
tableWithInformationsProfesiionalTreeview1 = [['', '', '', '', ''], ['    ID    ', '    Nome    ', '    Nascimento    ', '    Admissão    ', ' E-mail ', 'Telefone']]
